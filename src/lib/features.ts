...
export const FEATURES = [
  ...
  { id: "crews", label: "Crew manager", group: "Crew", hint: "Size, deal, look, crown — Separate is on Roster" },
  ...
  { id: "vocab", label: "Word Heat", group: "Learn", hint: "Blooket-style shop vocab quiz · Words" },
