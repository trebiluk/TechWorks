...
const CARDS: Record<string, DescribeCard> = {
  overview: {
    title: "Dashboard",
    purpose: "Class projector after Teach. Hour plate: Job · Guiding Q · Prove, then Agenda 2×2. Frame sandwich: Sky · °F word · lunch. Coral Cleanup in the last minutes: one leftover clock, two job lists. Aliases only.",
  ...
  teach: {
    title: "Teach",
    purpose: "Live board for this hour. Mid-class edits write back. Deck plays TEACH. Tools in the left Edge Pocket.",
    links: [{ label: "Help", href: "#help" }],
  },
  deck: {
    title: "Deck",
    purpose: "This hour’s slides. Present from here. Edit the hour on TEACH or PlanIt — same row.",
    links: [{ label: "Help", href: "#help" }],
  },
};
