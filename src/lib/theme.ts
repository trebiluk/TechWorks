...
export const THEMES = [
  { id: "solvay", label: "Dream", group: "solvay", kind: "dark", swatch: "#06122B", fg: "#F7F9FF", gold: "#22D3EE" },
  { id: "new-look", label: "TW Deluxe", group: "solvay", kind: "dark", swatch: "#06122B", fg: "#F7F9FF", gold: "#F0D48A" },
