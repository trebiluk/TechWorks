...
export type EconomyFile = {
  meta: {
    ...
    config?: {
      ...
      teachPack?: string;
      teachDays?: Record<string, Record<string, { pack?: string; objective?: string; pin?: string; notes?: string; ask?: string; do?: string; lines?: Record<string, string>; media?: HangItem[]; materials?: string; homework?: string; close?: string; mods?: string; reflect?: string; move?: string; skills?: string[]; share?: string; agenda?: { now?: string; goal?: string; next?: string; behave?: string } }>>;
