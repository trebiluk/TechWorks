...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    body: "Arrive → Teach. Green dots + “n of 8 hours set” mean that hour is planned. Type Agenda 01–04 and Need (goggles / stock); it is the Wall, the Deck, and PlanIt. Paste a Drive or Canva link on Hang — it plays on the Wall under Agenda. See wall is next to Deck. Fill P8 copies this hour onto the other same-grade class only if it is empty. Wall: Enter is sit / need / in a minute, then a chime into Agenda 2×2 with This week under it, coral Cleanup in the last minutes. After the last bell the Agenda stays. Crew lead PIN: today’s make, last marks, Buy if the catalog has perks.",
  },
  {
    id: "admin-crews",
    category: "Admin",
  ...
  },
  {
    ...
    body: "Web on the HUD, or ?web=1. Class web code is the portal PIN (default 2627 — change in Settings). Not the teacher PIN. Aliases, skill charts, family sheet. No wallet. Crew tab is aliases in that crew.",
  },
  {
    id: "ferpa",
    category: "Privacy",
  ...
  },
  {
    id: "first-names",
    category: "Privacy",
    title: "Show first real names",
    tags: ["names", "alias", "legal", "ferpa", "desk", "first", "privacy"],
    body: "Settings → Privacy, or First names on the Score pad. Puts legal first names on teacher pads: Score, Crew, Skills, Wallet, Prints, Hall, Data, Grades. Last names stay in the vault. Off by default. Wall, Teach, Deck, Family web, and a locked projector stay aliases. Crew 2222 can see first names if you turned the switch on — they cannot change it.",
  },
  {
    id: "export",
    category: "Export",
