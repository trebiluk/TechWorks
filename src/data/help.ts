...
export const HELP_ARTICLES: HelpArticle[] = [
  ...
  },
  {
    ...
    wall: true,
    body: "Last five minutes: coral screen. One leftover clock. Berty points at jobs. Workshop: tools, scraps, stations. Classroom: seats and aisles. Extra tidy catch is on Teach (PIN), not the student wall. Between classes Berty points at ENTER → LISTEN → CREW WORK → CLEAN UP.",
  },
  {
    id: "wall-lang",
    category: "Wall",
