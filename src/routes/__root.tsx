      ...
      <head>
        ...
        <script
          dangerouslySetInnerHTML={{
            __html: `(function(){try{if(window.parent&&window.parent!==window){window.parent.postMessage({channel:"grok-preview-bridge",version:1,type:"ready",path:location.pathname||"/"},"*");}}catch(e){}try{var t=localStorage.getItem("techworks-theme-v4")||localStorage.getItem("techworks-theme-v3");if(t)document.documentElement.setAttribute("data-theme",t);else document.documentElement.setAttribute("data-theme","solvay");var light={daylight:1,snowday:1,manila:1,peach:1,lemon:1,seafoam:1,lilac:1,rosewater:1,sky:1,linen:1,honey:1,polar:1,mintice:1,cottonday:1,wrapping:1,frostday:1,valentine:1,pumpkin:1,cloverday:1,patriotday:1};var th=document.documentElement.getAttribute("data-theme");document.documentElement.setAttribute("data-kind",light[th]?"light":"dark");document.documentElement.setAttribute("data-layout","one");document.documentElement.setAttribute("data-look","on");document.documentElement.style.setProperty("--ui-base","18px");document.documentElement.style.setProperty("--ui-title","1.18");document.documentElement.style.setProperty("--ui-fill","1");document.documentElement.style.setProperty("--ui-glow","0.92");document.documentElement.style.setProperty("--ui-shadow","0.88");}catch(e){}})();`,
          }}
        />
      </head>
