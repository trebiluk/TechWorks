/* KZ 1.16.1 — short lines, 1:1 EN/ES. Pictograms carry the rest. */
window.I18N = {
  en: {
    lang: "en",
    start: "Start here.",
    ...
    stopSpeak: "Stop",
    example: "Example",
    footer: "Koderized KZ 1.16.1 · alias only · not a SIS · no IEP/504",
  ...
  es: {
    ...
    stopSpeak: "Parar",
    example: "Ejemplo",
    footer: "Koderized KZ 1.16.1 · solo apodo · no es SIS · sin IEP/504",
